...
function Login() {
  ...
  async function handleLogin(event) {
    ...
    try {
      ...
      const locale = previousData.locale || getBrowserLocale();
      const timezone = previousData.timezone || getBrowserTimezone();
      ...
      await setDoc(
        userRef,
        {
          ...
          role: previousData.role || "client",
          locale,
          timezone,
          preferredRegion: previousData.preferredRegion || getLocaleRegion(locale),
          previousLoginDay: previousData.lastLoginDay || null,
          lastLoginDay: todayKey,
          loginCount: Number(previousData.loginCount || 0) + 1,
